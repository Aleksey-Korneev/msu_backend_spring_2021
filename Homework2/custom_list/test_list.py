...
class TestImmutability(unittest.TestCase):
    """
    Test immutability of custom lists after their being used.
    """
    def setUp(self):
        self.l1 = [0, 1, 2, 3, 4]
        self.cl1 = CustomList(self.l1)
